...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=16&duration=2800&pause=900&color=00FFFF&center=true&vCenter=true&width=620&lines=Code+is+the+common+language.;Write+it+together.+Own+it+together.;No+silos.+No+secrets.+Just+open+source.;Your+PR+is+our+PR." alt="Typing SVG" />
...
```
─────────────────────────────────────────────────────────────────
  INITIALISING: CodeCommons v1.0.0
  STATUS: OPEN TO ALL CONTRIBUTORS
  LICENCE: Community — forever free
─────────────────────────────────────────────────────────────────
```

## `>> THE COMMONS PHILOSOPHY`

Code that lives in a vault helps nobody. Code that lives in **the commons** - **reviewed, forked, extended, and reused -** builds whole ecosystems.

CodeCommons is an open ground where:
- **every student** can contribute without fear of judgment
- **every idea** gets a PR, not a rejection
- **every project** is a **shared asset**, not a solo trophy
